...
contract EspToken is Context, IBEP20, Ownable {
    ...
    address gamePool; // set a gamePool to receive tax fee, and in some way reback to users
    
    uint256 private constant _tTotal = 50000000 * 10**18;
    string private constant _name = "ExploShipToken";
    ...
    constructor (address _lockedPool, address _teamPool, address _ecoPool, address _communityPool, address _dexPool, address _gamePool) {
        //Test Net
        ...
        _balances[_lockedPool] = _tTotal*60/100;
        _balances[_teamPool] = _tTotal*10/100;
        _balances[_ecoPool] = _tTotal*20/100;
        _balances[_communityPool] = _tTotal*5/100;
        _balances[_dexPool] = _tTotal*5/100;
        gamePool = _gamePool;
